...
compSmearingDir = "response_"+Generator+"_"+Range+"_v4_eta0"
...
if AK4SF:
    ...
    infile1=BASEDIR + "/chiNtuple_" + Generator + Range + "_CB2.root"
    infile2=BASEDIR + "/chiNtuple_" + Generator + Range + "_GS.root"
...
def drawIt(h1,h2,h3,ptmin,ptmax):
    ...
    if SavePlots:
        outfile=compSmearingDir+"/SmearedResponse_" + Generator + "_" + str(int(ptmin)) + "pT" + str(int(ptmax))
        if AK4SF:
